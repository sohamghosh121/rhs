...
console.log(func0("abc", "def", [4,8]).toString());
var nested = rhs.compose(func0)(rhs.concat)(rhs.repeat)(rhs.concat)(rhs.single)(rhs.concat)();
console.log(nested(["abc", "def", [4, 8]], "end", 10000, "Please", [], ["yeah!"]).toString());
...
console.log(func2(["friend group", [4, 8]], "[^Soham]", 10000, " Dear Bodik, please be merciful on our grades").toString());
...
console.log(nested([["HongJun", "Soham "], 100000], "wee", "HongJun").toString());
